                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control" name="post_category_id" id="post_category_id"
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select form-control" name="post_sub_category_id" id="post_sub_category_id"
                                aria-label="Default select example">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" name="thumb_image" class="form-control" id="exampleInputPassword2"
                                required>
                        </div>
                        <div class="mb-3">
